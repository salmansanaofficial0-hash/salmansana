...
const Hero = () => (
  <section id="hero" className="min-h-screen pt-[90px] pb-16 md:pb-20 px-[5%] flex items-center justify-center bg-background relative overflow-hidden">
    ...
    <div className="relative z-[2] text-center max-w-2xl">
      ...
      <p className="text-[0.97rem] text-muted leading-[1.85] max-w-[500px] mx-auto mb-10 animate-slide-up" style={{ animationDelay: '0.21s' }}>
      ...
      <div className="flex gap-3 flex-wrap justify-center animate-slide-up" style={{ animationDelay: '0.28s' }}>
