...
const Navbar = () => (
  <nav className="fixed top-0 left-0 right-0 z-[200] flex justify-between items-center px-[5%] h-[70px] bg-background/95 backdrop-blur-[20px] border-b border-border">
    <a href="#" className="no-underline flex items-center">
      <svg className="h-[38px] w-auto" viewBox="0 0 220 44" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="https://www.linkedin.com/in/salman-sana-/" target="_blank" rel="noopener noreferrer"
       className="ml-2 bg-ink text-primary-foreground px-5 py-2 rounded-full no-underline text-[0.82rem] font-semibold tracking-wide transition-all border-[1.5px] border-ink inline-flex items-center gap-1.5 hover:bg-blue-mid hover:border-blue-mid hover:-translate-y-px hover:shadow-[0_6px_20px_rgba(37,99,235,0.25)]">
      <Linkedin size={13} />
      LinkedIn
    </a>
  </nav>
